...
def get_file_genes(filename):
	genes=pd.read_csv('../brain_RNA_big_gene_pool_pipeline/%s'%filename)
...
def load_positives_negatives():
	#positives=pd.read_csv('/Users/karenmei/Documents/Synapse_Ontology/NetworkClass/Entry_Ontology/synapse_9/input_genes/synapse_positives.csv')
	positive_file='../brain_RNA_big_gene_pool_pipeline/synapse_positives.csv'
	...
	positive_file='../brain_RNA_big_gene_pool_pipeline/synapse_negatives.csv'
